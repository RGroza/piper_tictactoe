...
void TrajectoryExecutor::loadWaypoints() {
    ...
    waypoints_.push_back(makePose(0.245f, 0.065f, HOVERING_Z));  // 1
    waypoints_.push_back(makePose(0.200f, 0.065f, HOVERING_Z));  // 2
    waypoints_.push_back(makePose(0.155f, 0.065f, HOVERING_Z));  // 3
    waypoints_.push_back(makePose(0.245f, 0.020f, HOVERING_Z));  // 4
    waypoints_.push_back(makePose(0.200f, 0.020f, HOVERING_Z));  // 5
    waypoints_.push_back(makePose(0.155f, 0.020f, HOVERING_Z));  // 6
    waypoints_.push_back(makePose(0.245f, -0.025f, HOVERING_Z)); // 7
    waypoints_.push_back(makePose(0.200f, -0.025f, HOVERING_Z)); // 8
    waypoints_.push_back(makePose(0.155f, -0.025f, HOVERING_Z)); // 9
}
...
void TrajectoryExecutor::moveToClear() {
    ...
    moveByDelta(0.0f, 0.0f, -DRAW_Z_OFFSET);
    moveByDelta(0.0f, 0.0f, +DRAW_Z_OFFSET);
    moveToHome();
}
