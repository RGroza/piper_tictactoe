    ...
    MJPEGCANVAS.Viewer = function (a) {
        function b() {
            if (c.canvas.width = c.canvas.width,
                c.image.width * c.image.height > 0 ? i.drawImage(c.image, 0, 0, c.width, c.height) : (i.drawImage(h.image, (c.width - c.width / 2) / 2, (c.height - c.height / 2) / 2, c.width / 2, c.height / 2),
